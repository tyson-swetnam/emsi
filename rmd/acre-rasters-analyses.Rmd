...
ggsave('~/Documents/ndvi_timeseries_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/ndvi_timeseries_acre.png', width = 22, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/ndvi_2010_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/ndvi_2006_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/emsi_timeseries_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/emsi_2010_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/emsi_2006_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
...
ggsave('~/Documents/emsi_2016_acre.png', width = 12, height = 8, dpi = 300, bg = "transparent")
```
