var landsat8_lasrc1 = ee.ImageCollection("LANDSAT/LC08/C01/T1_SR"),
...
// Load the Landsat 8 Surface Reflectance Tier 1 and 2 collections (see Imports above)
// Create a Study Area polygon (see Imports above)
// Create an area of interest for each RAWS location (see Imports above)
          
// Filter scenes that intersect the study region for the period of Landsat 8 
var landsat8_lasrc1_SA = landsat8_lasrc1.filterBounds(studyArea).filterDate('2013-04-11',
 '2018-05-31');

// Mosaic scene for viewer
var mosaic = landsat8_lasrc1.filterBounds(region).filterDate('2018-01-01', 
  '2018-04-01').mosaic();
...
var landsat8_lasrc1_free = landsat8_lasrc1_SA.map(maskClouds);
...
Map.addLayer(landsat8_lasrc1_free, visParams, 'Landsat 8 without clouds'); 

///////////////////////////////////////////////////////

// Compute the Normalized Difference Vegetation Index (NDVI) for the cloud free imagery

var calc_ndvi = function(landsat8_lasrc1_free) {
