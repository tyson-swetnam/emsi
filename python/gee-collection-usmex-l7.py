...
l7=ee.ImageCollection('LANDSAT/LE07/C01/T1_SR').filterDate('1999-05-17', '2021-03-01').filterBounds(geom)
...
def exportCollectionToDrive (userCollection,folderName):
    ...
    def exportImage(img):
        ...
        if imgp.getInfo()>=0.7:
            task = ee.batch.Export.image.toDrive(
                ...
                folder = 'gee-collection-usmex-landsat7-2021',
                maxPixels = 1e13,
                region = fileGeometry,
                scale = 30)
            task.start()
    ...
    print('')
exportCollectionToDrive(userCollection=l7, folderName="gee-collection-usmex-landsat7-2021")
